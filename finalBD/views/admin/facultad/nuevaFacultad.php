...
<head>
	...
	<title>Administracion facultades</title>
</head>
<body id="index">
	...
	<br><br><br><br>
	<h1 id="EAdmin">Administracion facultad</h1>
	<div class="botonesModal">
		<a href="#" id="btnNuevaFacultad" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#Nuevo">Nueva</a>
		<a href="#" id="VerFacultades" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#VerP">Ver todas</a>
	</div>
