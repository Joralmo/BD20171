  ...
  <body id="index">
	...
	<div class="col-md-12">
		...
		<div id="box" class="col-md-4">
			<div id="up" class="row">
				<h4 class="text-center">Login Estudiantes</h4>
			</div>
				...
				<div class="col-md-10">
					<form action="login" method="post">
						...
						<?php 
						 ...
						 ?>
						<center><button type="submit" class="btn btn-success" id="entrarLogin">Entrar</button></center>
						<center><small><a href="loginProfesor">Soy profesor</a></small></center>
					</form>
				</div>
				<div class="col-md-1"></div>
			</div>
