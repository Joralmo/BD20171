...
<head>
	...
	<title>Administracion carreras</title>
</head>
<body id="index">
	...
	<br><br><br><br>
	<h1 id="EAdmin">Administracion carrera</h1>
	<div class="botonesModal">
		<a href="#" id="btnNuevaCarrera" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#Nuevo">Nueva</a>
		<a href="#" id="VerCarreras" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#VerP">Ver todas</a>
	</div>
