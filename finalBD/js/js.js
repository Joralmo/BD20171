jQuery(document).ready(function($) {
	...
	$.post('getDatos',function(msg){
			...
			for(todo of json){
				...
				formAsignatura+='<th width="260px" class="bg-warning">'+dias[dia]+'</th><th class="bg-warning">'+todo["horaInicio"][0]+''+todo["horaInicio"][1]+' - '+todo["horaFin"][0]+''+todo["horaFin"][1]+'</th><th class="bg-warning"><a href="#" id='+i+'><i class="material-icons">done</i></a></th></tr>';
				i++;
			}
	...
	modificarHorario.click(function(event) {
		...
		tablamatAgregar.on("click", 'tr', function(e){
			...
			grupos.push(rellenarTabla[agregar]["idGrupos"]);
			console.log(grupos)
			tablaPre=$(".preHorario tr:last");
			dia=rellenarTabla[agregar]["Dias"]-1;
			tablaPre.after("<tr><th>"+rellenarTabla[agregar]["NombreMateria"]+"</th><th>"+rellenarTabla[agregar]["Nombre"]+' '+rellenarTabla[agregar]["Apellido"]+"</th><th>"+rellenarTabla[agregar]["Numero"]+"</th><th>"+dias[dia]+"</th><th>"+rellenarTabla[agregar]["horaInicio"][0]+""+rellenarTabla[agregar]["horaInicio"][1]+" - "+rellenarTabla[agregar]["horaFin"][0]+""+rellenarTabla[agregar]["horaFin"][1]+"</th></tr>")
